...
int sx, sy , ex, ey;
vector<vector<char>> a(1003 , vector<char> (1003,'#')) ;
vector<vector<char>> vis(1003,vector<char> (1003,'#'));
vector<char> path;
vector<vector<char>> dir(1003,vector<char> (1003));
string s={'D','R','L','U'};
